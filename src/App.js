                        ...
                        <div className="projects__inner container-fluid">
                            <div className="projects__inner__content container justify-content-center">
                                <div className="projects__inner__content__opener">
                                    Personal projects to capture my creative energy, design solutions, and make them reality. Below are a few of my
                                    active projects:
                                </div>
                                ...
                                <div className="projects__inner__content__text">
                                    ...
                                    designed to
                                    effortlessly handle role balancing and schedule creation for organizers while providing
                                ...
                                <div className="projects__inner__content__text">
                                    ...
                                    study the in-game market economics of the game since it's release in 2004. Along
                                    with my
                                    friend and coding partner, <a href="https://github.com/Heanthor"
                                                                  className="projects__inner__content__text--link">Reed
                                    Trevelyan</a>, we
                                    worked to
                                    bring my designs to life. Reed's efforts took the concept and specifications: an
                                    interface to allow users to esily obtain information on the market value of products
                                    and
                                    commodities in the game, and produced a Discord chat bot that any player could add
                                    to
